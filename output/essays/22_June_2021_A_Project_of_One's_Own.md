...
the things one has to write in English classes are so
 [bogus](https://paulgraham.com/essay.html)
 . And
...
order, or
 [slowed down](https://paulgraham.com/artistsship.html)
 by bureaucracy.
...
"Hobby" is a curious word. Now it means work that isn't
 *real* 
...
was to acquire
 [credentials](https://paulgraham.com/credentials.html)
...
**Thanks** 
 to Trevor Blackwell, Paul Buchheit, Andy Hertzfeld, Jessica
