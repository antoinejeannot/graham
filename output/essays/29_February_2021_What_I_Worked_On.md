 ...
 *The Moon is a Harsh Mistress* 
 , which featured an intelligent
computer called Mike, and a PBS documentary that showed Terry
Winograd using SHRDLU. I haven't tried rereading
 *The Moon is a Harsh
Mistress* 
 , so I don't know how well it has aged, but when I read it
...
learn it. The book,
 *On Lisp* 
 , wasn't published till 1993, but I wrote
...
things in profiles in
 *Life* 
 magazine. The idea of actually being
...
working away at
 *On Lisp* 
 . In other words, like many a grad student,
...
remained before the deadline, reusing parts of
 *On Lisp* 
 where I
...
all I had to do was learn Italian.
 ...
 Only
 *stranieri* 
 (foreigners) had to take this entrance exam. In
retrospect it may well have been a way of excluding them, because
there were so many
 *stranieri* 
 attracted by the idea of studying
...
spent much of my time surreptitiously working on
 *On Lisp* 
 , which I
...
this book,
 *ANSI Common Lisp* 
 , is one that I painted around this
time.)
...
of
 *ANSI Common Lisp* 
 to the publishers, we started trying to write
...
we did what's now called "doing things that
 [don't scale](https://paulgraham.com/ds.html)
 ," although
...
in much the same way I was converted to
 [fatherhood](https://paulgraham.com/kids.html)
 once I had kids.
...
combined with Yahoo's prematurely aged
 [culture](https://paulgraham.com/yahoo.html)
 and grim cube farm
...
published in
 *The New Yorker* 
 . But by this point I knew enough to
...
book, called
 *Hackers \& Painters* 
 after one of the essays in it. I
...
while I continued to work a good deal
 *in* 
 Arc, I gradually stopped
working
 *on* 
 Arc, partly because I didn't have time to, and partly
...
the next few months. I even wrote a couple that
 [weren't](https://paulgraham.com/know.html)
 about
...
like
 *polluzione* 
 ). It's the everyday words that differ. So if you
...
comes with the territory. An essay must tell readers things they
 [don't already know](https://paulgraham.com/useful.html)
 , and some 
...
**Thanks** 
 to Trevor Blackwell, John Collison, Patrick Collison, Daniel
